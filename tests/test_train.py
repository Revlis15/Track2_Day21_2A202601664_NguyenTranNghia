...
def _make_temp_data(tmp_path):
    ...
    # 2. Tao mang y gom n phan tu nguyen ngau nhien trong [0, 2)
    ...
    # 4. Luu 160 dong dau lam tap huan luyen, 40 dong cuoi lam tap holdout
...
def test_train_returns_float(tmp_path):
    ...
    # 6. Goi ham train() voi sieu tham so nho
    f1 = train(
